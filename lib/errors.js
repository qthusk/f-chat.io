...
// Codes and descriptions taken from https://wiki.f-list.net/F-Chat_Error_Codes
module.exports = {
  ...
  31:     "You have been disconnected because this character has been logged " +
  ...
  38:     "The time given for the timeout was invalid. It must be a number " +
          "between 1 and 90 minutes.",
  39:     "You have been given a time out by <moderator name> for " +
          "<length> minute(s). The reason given was: <reason>",
  ...
  54:     "Please wait two minutes between calling moderator. If you need to " +
          "make an addition or a correction to a report, please contact a " +
          "moderator directly.",
  ...
  64:     "Your ignore list may not exceed 100 people.",
  ...
  '-2':   "An error occured while processing your command.",
  '-3':   "This command has not been implemented yet.",
  '-4':   "A connection to the login server timed out. Please try again" +
          "in a moment.",
